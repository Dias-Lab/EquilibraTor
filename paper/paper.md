...
![Last simulation frame of the glycosyltransferase–preQ0 complex generated by EquilibraTor and visualized in PyMOL. This system corresponds to the final conformation obtained after energy minimization and equilibration, automatically extracted from the GROMACS trajectory.\label{fig:lastframepdb}](figures/protein-ligand_eq_last_frame.png)
